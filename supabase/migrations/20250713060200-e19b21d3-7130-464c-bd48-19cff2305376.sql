-- Insert sample data for testing (Fixed order)
-- First insert profiles without foreign key dependencies
INSERT INTO public.profiles (id, user_id, first_name, last_name, email, role, admission_number, id_number, department, year_of_study) VALUES
  ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'John', 'Doe', 'john.doe@student.zetech.ac.ke', 'student', 'ZU/2024/001', '12345678', 'Computer Science', 2),
  ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000002', 'Jane', 'Smith', 'jane.smith@student.zetech.ac.ke', 'student', 'ZU/2024/002', '12345679', 'Computer Science', 2),
  ('00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000003', 'Michael', 'Johnson', 'michael.johnson@student.zetech.ac.ke', 'student', 'ZU/2024/003', '12345680', 'Engineering', 3),
  ('00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000004', 'Sarah', 'Wilson', 'sarah.wilson@student.zetech.ac.ke', 'student', 'ZU/2024/004', '12345681', 'Business', 1),
  ('00000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000005', 'Mark', 'Sweat', 'mark.sweat@zetech.ac.ke', 'admin', NULL, '98765432', 'Administration', NULL);

-- Sample classes (now profiles exist)
